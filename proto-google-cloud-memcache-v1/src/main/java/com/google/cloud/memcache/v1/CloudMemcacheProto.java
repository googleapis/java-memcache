  ...
  static {
    java.lang.String[] descriptorData = {
      "\n"
          ...
          + " google/protobuf/field_mask.proto\032\037google/protobuf/timestamp.proto\"\243\014\n"
          + "\010Instance\022\021\n"
          ...
          + " \001(\0132-.google.cloud.memcache.v1.Instance.NodeConfigB\003\340A\002\022C\n"
          ...
          + " \003(\0132\'.google.cloud.memcache.v1.Instance.NodeB\003\340A\003\0224\n"
          ...
          + " \003(\01322.google.cloud.memcache.v1.Instance.InstanceMessage\022\037\n"
          ...
          + "ListInstances\022..google.cloud.memcache.v1.ListInstancesRequest\032/.google.cloud.memcache.v1.ListInstancesResponse\">\202\323\344\223\002/\022-/v1/{parent=projects/*/locations/*}/instances\332A\006parent\022\235\001\n"
          + "\013GetInstance\022,.google.cloud.memcache.v1.GetInstanceRequest\032\".google.cloud.memcache.v1.Instance\"<\202\323\344\223\002/\022-/v1/{name=projects/*/locations/*/instances/*}\332A\004name\022\222\002\n"
          + "\016CreateInstance\022/.google.cloud.memcache.v1.CreateInstan"
          + "ceRequest\032\035.google.longrunning.Operation\"\257\001\202\323\344\223\0029\"-/v1/{parent=projects/*/locations/*}/instances:\010instance\332A\033parent,instance,instance_id\312AO\n"
          + "!google.cloud.memcache.v1.Instance\022*google.cloud.memcache.v1.OperationMetadata\022\224\002\n"
          + "\016UpdateInstance\022/.google.cloud.memcache.v1.UpdateInstanceR"
          + "equest\032\035.google.longrunning.Operation\"\261\001\202\323\344\223\002B26/v1/{instance.name=projects/*/locations/*/instances/*}:\010instance\332A\024instance,update_mask\312AO\n"
          + "!google.cloud.memcache.v1.Instance\022*google.cloud.memcache.v1.OperationMetadata\022\240\002\n"
          + "\020UpdateParameters\0221.google.cloud.memcache.v1.UpdateParamete"
          + "rsRequest\032\035.google.longrunning.Operation\"\271\001\202\323\344\223\002C2>/v1/{name=projects/*/locations/*/instances/*}:updateParameters:\001*\332A\033name,update_mask,parameters\312AO\n"
          + "!google.cloud.memcache.v1.Instance\022*google.cloud.memcache.v1.OperationMetadata\022\345\001\n"
          + "\016DeleteInstance\022/.google.cloud.memcache.v1.DeleteInstanceRequest\032\035.google.longrunning.Operation\"\202\001\202\323\344\223\002/*-/v1/{name=projects/*/locations/*/instances/*}\332A\004name\312AC\n"
          + "\025google.protobuf.Empty\022*google.cloud.memcache.v1.OperationMetadata\022\231\002\n"
          + "\017ApplyParameters\0220.google.cloud.memcache.v1.ApplyParamet"
          + "ersRequest\032\035.google.longrunning.Operation\"\264\001\202\323\344\223\002B\"=/v1/{name=projects/*/locations/*/instances/*}:applyParameters:\001*\332A\027name,node_ids,apply_all\312AO\n"
          + "!google.cloud.memcache.v1.Instance\022*google.cloud.memcache.v1.OperationMetadata\032K\312A\027memcache.googleapis.com\322A.https://www.googleapis.com/auth/cloud-platformBv\n"
          + "\034com.google.cloud.memcache.v1B\022CloudMemcacheProtoP\001Z@goo"
          + "gle.golang.org/genproto/googleapis/cloud/memcache/v1;memcacheb\006proto3"
    };
    descriptor =
